define(['app'], function(app) {
	app.controller('profilePageCtrl', ['$scope', '$http', 'notificationService', function($scope, $http, notificationService) {
	    $scope.setting = {
        // isModify : false,
        isVisit : false,
        isFinish : 'false'
      ...
      $scope.cancel = function() {
        // $scope.setting.isModify = false;
      }

      $scope.submitForm = function() {
        console.log($scope.profile)
        notificationService.success('info');
      }
